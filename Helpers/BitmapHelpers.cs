...
namespace GI.Common.XF.Android.Helpers
{
    ...
    public class BitmapWorkerTask : AsyncTask<int, int, Bitmap>
	{
		...
		public BitmapWorkerTask(ContentResolver cr, Uri uri)
		{
			uriReference = uri;
			resolver = cr;
		}
		...
		protected override Bitmap RunInBackground(params int[] p)
		{
			...
			Bitmap mBitmap = Provider.MediaStore.Images.Media.GetBitmap(resolver, uriReference);
