...
using GI.Common.XF.Android.Extensions;
...
namespace GI.Common.XF.Android.Renderers
{
        ...
        TextView.IOnEditorActionListener
    {
        ...
        protected override TextInputLayout CreateNativeControl()
        {
            ...
            {
                SupportBackgroundTintList = ColorStateList.ValueOf(AColor.Transparent)
            };
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<XfxEntry> e)
        {
            ...
            if (e.NewElement != null)
            {
                ...
                var ele = (ITintableBackgroundView)EditText;
                ele.SupportBackgroundTintList = ColorStateList.ValueOf(AColor.Transparent);
            }
        }
        ...
        protected AColor GetPlaceholderColor() => Element.PlaceholderColor.ToAndroid(Color.White);
        ...
        {
            EditText.SetTextColor(AColor.White);
